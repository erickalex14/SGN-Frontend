...
## Corpus Check
- 24 files · ~42,944 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 151 nodes · 166 edges · 20 communities (16 shown, 4 thin omitted)
...
Cohesion: 0.16
Nodes (16): LoginPage(), Order, OrderDetail(), PartItem, Workflow, Order, OrderList, priorityLabel (+8 more)
