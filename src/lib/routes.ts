...
export const routeDefinitions: Record<string, RouteDefinition> = {
  ...
  "operaciones/atencion-cliente": { title: "Atención al cliente", group: "Órdenes" },
  "operaciones/repuestos-pendientes": { title: "Repuestos pendientes", group: "Órdenes" },
  "operaciones/notas-credito-pendientes": { title: "Notas de crédito pendientes", group: "Órdenes" },
  "operaciones/entregas-pendientes": { title: "Entregas pendientes", group: "Órdenes" },
