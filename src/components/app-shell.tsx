...
const groups: Group[] = [
  ...
  { icon: "bi-box-seam", label: "Inventario", items: [{ href: "/inventario/productos", icon: "bi-box", label: "Productos" }, { href: "/inventario/marcas", icon: "bi-tags", label: "Marcas" }, { href: "/inventario/repuestos", icon: "bi-tools", label: "Repuestos" }, { href: "/operaciones/inventario-fisico", icon: "bi-boxes", label: "Inventario Físico ST" }, { href: "/operaciones/listas-compra", icon: "bi-cart", label: "Listas de Compra" }] },
