...
type Workflow = { order: Order; evidence: { id: string; type: string; fileName: string; createdAt: string }[]; partsRequest: PartsRequest | null; quotes: Quote[] };
